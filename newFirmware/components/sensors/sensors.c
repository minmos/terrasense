...
void sensors_init(sys_debug_led_t *debug_led)
{
    ...
    sensor_ds18b20_init(ONEWIRE_BUS_GPIO, HARDWARE_DS18B20_CONFIG, HARDWARE_DS18B20_COUNT, debug_led);
#endif
#if HARDWARE_SHT3X_ENABLED
    ...
    sensor_sht3x_init(I2C_MASTER_PORT, I2C_SDA_GPIO, I2C_SCL_GPIO, HARDWARE_SHT3X_CONFIG, HARDWARE_SHT3X_COUNT, debug_led);
#endif
#if HARDWARE_BINARY_ENABLED
